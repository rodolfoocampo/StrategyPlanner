...
_**Healthy Country AI initially**_
![Healthy Country AI](./Photos/before.png)

_**Healthy Country AI with Strategy Planner**_
...
_**Dashboard: Introduction page**_
![Introduction](./Photos/Introduction.png)

_**Dashboard: Strategy Metrics page**_
![Strategy Metrics](./Photos/StrategyMetrics.png)

_**Dashboard: Strategy Visualiser**_
